...
def main(force=False):
    ...
    if force:
        print("[SYNC] ⚠️ Force mode enabled: regenerating log regardless of change")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Sync asset files and generate daily logs.")
    parser.add_argument("--force", action="store_true", help="Force regeneration of log even if no file changes.")
